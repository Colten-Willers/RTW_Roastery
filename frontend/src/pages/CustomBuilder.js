      ...
      case 4:
        return (
          ...
          >
            ...
            <div className="mb-4 p-4 bg-aged-brass/10 rounded-sm border border-aged-brass/30">
              <p className="text-sm text-polo-green">
                <span className="font-semibold">Recommended for {brewingMethods.find(m => m.value === blend.brewing_method)?.label}:</span> {brewingMethods.find(m => m.value === blend.brewing_method)?.grind}
              </p>
            </div>
            <RadioGroup
